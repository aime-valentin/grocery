...
public class Electronic extends Product implements IElectronic, Ifilter, Isort {

	public Electronic(String name, BufferedImage image, String manfnfo, String descrpt, double height, double width,
